...
def convert_slides_to_pdf(html_file, output_pdf='output.pdf'):
    ...
    with sync_playwright() as p:
        ...
        slide_dimensions = page.evaluate("""() => {
            ...
            for (const sel of selectors) {
                ...
                if (slides.length > 1) {
                    ...
                    return {
                        width: firstSlide.offsetWidth || parseInt(computed.width) || rect.width,
                        height: firstSlide.offsetHeight || parseInt(computed.height) || rect.height
                    };
                }
            }
        ...
        print(f"🔍 Kích thước slide phát hiện: {slide_dimensions['width']}x{slide_dimensions['height']}")
